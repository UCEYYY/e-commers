...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="{{route('dashboard')}}">E-commers</a>
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a href="" class="nav-link px-3" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Sign out</a>
  ...
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="produk.index">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <footer class="text-muted py-5">
        @copyright &copy; {{ date('Y') }} E-commers. All rights reserved.
      </footer>
